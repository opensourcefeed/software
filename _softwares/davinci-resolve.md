...
featured_image: davinci-resolve.webp
...
- **Color grading** — Industry-standard color correction tools originating from Resolve's color-suite heritage
- **Cut and Edit pages** — Timeline-based non-linear editing with a streamlined "Cut" mode for fast turnaround
- **Fairlight audio** — Integrated digital audio workstation for mixing and sound design without leaving the app
- **Fusion** — Node-based compositing and motion graphics/VFX tools built into the same application
- **Free tier with no time limit** — Full editing, color, audio, and VFX functionality available at no cost
- **Cross-platform** — Native support for Windows, macOS, and Linux, unlike most competing NLEs

## Use Cases

- **Color grading** — Professional-grade color correction for film, television, and online video
- **Independent filmmaking** — A no-cost, full post-production pipeline in a single application
- **Podcast and audio-heavy video** — Integrated Fairlight audio tools alongside video editing
- **Cross-platform production teams** — Studios mixing Linux, Windows, and macOS workstations

## Who It's For

DaVinci Resolve is aimed at video editors and colorists who want a full post-production suite — editing, grading, audio, and VFX — without necessarily paying a subscription, since the free edition covers most workflows on its own. It's proprietary and closed source, with a paid one-time Studio upgrade for advanced features, multi-user project collaboration, and higher-end format support.
