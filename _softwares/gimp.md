...
GIMP (GNU Image Manipulation Program) is a free and open source raster graphics editor. It provides a comprehensive set of tools for photo retouching, image composition, and graphic design. GIMP is cross-platform and available for Linux, Windows, and macOS.
...
- **Filters and effects** — Extensive plugin library with scriptable filters (Script-Fu and Python-Fu)
...
- **Customizable interface** — Dockable dialogs and customizable workspace
...
<!-- TODO: expand with workflow tutorials and plugin recommendations -->