...
faq:
  - question: "Is Telegram open source?"
    answer: "Partially — see the Is Telegram Open Source? section above for the full client/server split. In short, Telegram's Android, iOS, and desktop clients are open source, but the server that stores and routes messages is closed source and run entirely by Telegram FZ-LLC."
---
