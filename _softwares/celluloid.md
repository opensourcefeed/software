...
title: "Celluloid"
slug: celluloid
tagline: "Simple GTK4 frontend for mpv"
type: open-source
license: GPL-3.0
...
featured_image: celluloid.webp
last_modified_at: 2026-09-17
---

## Overview

Celluloid is a free and open source media player that wraps mpv's powerful playback engine in a straightforward GTK4/libadwaita interface. Originally called GNOME MPV, it was renamed to Celluloid to reflect its broader ecosystem — it works on any GTK-based desktop environment, not just GNOME.
...
- **Lightweight GTK4 interface** — Native GTK4/libadwaita interface that blends with GNOME, Xfce, and other GTK desktops
